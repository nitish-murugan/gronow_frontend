...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
        ...
        <div className="flex items-center">
          {!user ? (
            <button
              ...
              className="px-6.5 py-1.5 bg-primary hover:bg-primary-dull text-white rounded-full"
            >
              Login
            </button>
          ) : (
      ...
      {/* Mobile Dropdown */}
      {open && (
        <div className="absolute top-full left-0 w-full bg-white shadow-md flex flex-col items-start gap-2 px-5 py-4 sm:hidden z-50">
          ...
          {!user ? (
            <button
              ...
              className="px-6 py-2 bg-primary text-white rounded-full mt-2 w-full text-center"
            >
              Login
            </button>
          ) : (
          ...
          <button
            ...
            className="px-6 py-2 bg-gray-100 rounded-full mt-2 w-full text-center"
          >
            Contact Us
          </button>
        </div>
